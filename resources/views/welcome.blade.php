...
@section('content')
        <main class="max-w-7xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-12">
                <div class="bg-gradient-to-r from-yellow-400 via-orange-400 to-orange-500 rounded-xl shadow-lg p-1 max-w-md mx-auto">
                    <div class="bg-white rounded-lg p-6">
                        <div class="flex items-center justify-center w-12 h-12 bg-orange-100 rounded-full mb-4 mx-auto">
                            <svg class="w-6 h-6 text-orange-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                            </svg>
                        </div>
                        <h3 class="text-lg font-semibold text-gray-900 mb-2">¿Necesitas Ayuda?</h3>
                        <p class="text-gray-600 text-sm mb-4">Consulta nuestro manual de ayuda con guías paso a paso</p>
                        <a href="{{ route('help.public') }}" 
                           class="inline-flex items-center justify-center w-full bg-orange-500 hover:bg-orange-600 text-white font-medium py-3 px-6 rounded-lg transition-colors duration-200 group">
