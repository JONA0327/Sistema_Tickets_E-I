...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Detalles de Uso - {{ $discoEnUso->inventario->codigo_inventario }} - E&I Sistema de Inventario</title>
                    ...
                    <div class="flex items-center">
                        <div class="flex-shrink-0">
                            <div class="flex items-center">
                                ...
                                <div>
                                    <h1 class="text-xl font-bold text-gray-900">Detalles de Disco en Uso</h1>
