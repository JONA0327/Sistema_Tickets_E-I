                    ...
                    <div class="flex items-center">
                        <div class="flex-shrink-0">
                            <div class="flex items-center">
                                ...
                                <div class="min-w-0">
                                    <h1 class="text-lg sm:text-xl font-bold text-gray-900 leading-tight">Panel de Administración</h1>
                                    <p class="text-xs sm:text-sm text-gray-600">E&I - Tecnología</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="flex flex-col md:flex-row md:items-center md:justify-end gap-4 md:gap-6">
                        ...
                        <div class="flex items-center justify-center md:justify-end gap-4">
                            ...
                            <div class="relative" x-data="notificationDropdown()" x-init="init()">
                                ...
                                <div x-cloak x-show="isOpen"
                                     ...
                                     class="absolute right-0 mt-2 w-80 sm:w-96 bg-white rounded-lg shadow-xl ring-1 ring-black ring-opacity-5 focus:outline-none z-50 max-h-96 overflow-hidden">
                            ...
                            <div class="relative" x-data="{ open: false }">
                                <button @click="open = !open"
                                        class="flex items-center justify-center md:justify-between space-x-2 text-sm rounded-full bg-blue-50 p-2 text-gray-700 hover:bg-blue-100 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
