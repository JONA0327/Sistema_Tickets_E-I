        ...
        <main class="max-w-7xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between mb-8">
                ...
                <div class="flex flex-col sm:flex-row gap-3 sm:items-center">
                    ...
                    <form method="POST" action="{{ route('admin.maintenance.slots.destroy-past') }}" class="inline-flex" onsubmit="return confirm('¿Eliminar todos los horarios pasados? Esta acción cancelará las reservaciones asociadas.');">
                        @csrf
                        @method('DELETE')
            ...
            <div class="bg-white border border-blue-100 rounded-xl shadow-sm p-6 mb-10">
                <h3 class="text-lg font-semibold text-gray-900 mb-2">Registrar ficha técnica de equipo</h3>
                <p class="text-sm text-gray-600 mb-6">Centraliza la información técnica de los equipos intervenidos para consultarla desde el historial de expedientes.</p>

                <form method="POST" action="{{ route('admin.maintenance.computers.store') }}" class="space-y-6">
                    @csrf
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" id="identifier" name="identifier" value="{{ old('identifier') }}" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" required>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" id="brand" name="brand" value="{{ old('brand') }}" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            ...
                            <div>
                                ...
                                <input type="text" id="model" name="model" value="{{ old('model') }}" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            ...
                            <input type="text" id="disk_type" name="disk_type" value="{{ old('disk_type') }}" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                        ...
                        <div>
                            ...
                            <input type="text" id="ram_capacity" name="ram_capacity" value="{{ old('ram_capacity') }}" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="datetime-local" id="last_maintenance_at" name="last_maintenance_at" value="{{ old('last_maintenance_at') }}" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                        ...
                        <div>
                            ...
                            <textarea id="aesthetic_observations" name="aesthetic_observations" rows="3" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">{{ old('aesthetic_observations') }}</textarea>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2">
                            @foreach($componentOptions as $value => $label)
                                <label class="inline-flex items-center text-xs text-gray-600 bg-gray-50 border border-gray-200 rounded-lg px-3 py-2">
                                    <input type="checkbox" name="replacement_components[]" value="{{ $value }}" class="mr-2 rounded border-gray-300 text-blue-600 focus:ring-blue-500" {{ is_array(old('replacement_components')) && in_array($value, old('replacement_components', []), true) ? 'checked' : '' }}>
                                    {{ $label }}
                                </label>
                            @endforeach
                        </div>
                    ...
                    <div class="bg-gray-50 border border-gray-200 rounded-lg p-4 space-y-3">
                        <label class="flex items-start text-sm text-gray-700">
                            <input type="checkbox" name="is_loaned" value="1" class="mt-1 mr-2 rounded border-gray-300 text-green-600 focus:ring-green-500" {{ old('is_loaned') ? 'checked' : '' }}>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" id="loaned_to_name" name="loaned_to_name" value="{{ old('loaned_to_name') }}" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            ...
                            <div>
                                ...
                                <input type="email" id="loaned_to_email" name="loaned_to_email" value="{{ old('loaned_to_email') }}" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
